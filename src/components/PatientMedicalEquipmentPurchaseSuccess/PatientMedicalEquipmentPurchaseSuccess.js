...
import styles from './PatientMedicalEquipmentPurchaseSuccess.styles';
import images from '@assets/images';
import {SafeAreaInsetsContext} from 'react-native-safe-area-context';

const {width} = Dimensions.get('screen');

class PatientMedicalEquipmentPurchaseSuccess extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    //this.mixpanel.track('View Medical Equipment Purchase Success');
  }
              ...
              <View style={styles.innerContainer}>
                ...
                <View style={styles.textIconContainer}>
                  <View style={styles.iconContainer}>
                    <Image style={styles.vanIcon} source={images.van} />
                  </View>
